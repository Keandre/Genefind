...
class GeneToModelConverter:
    ...
    def _extract_acid_table(self, pdbfile):
        ...
        for line_range in acid_ranges:
            ...
            acid = self._build_reference_acid(pdb_atoms, previous_tail)
            previous_tail = acid.tail()
            acid_table[acid.name] = acid

        return acid_table
        
    def _build_reference_acid(self, pdb_atoms, previous_tail):
...
table = GeneToModelConverter("1akp.pdb")
